...
16 files will have been generated, each with varying levels of access enabled or disabled. To execute the tasks associated with the second phase: ./acmonitor -m or ./acmonitor -i <filename>
...
./acmonitor -m print the users that have shown malicious activity
./acmonitor -i <filename> will show for a given filename the amount of times users have modified the given file.
